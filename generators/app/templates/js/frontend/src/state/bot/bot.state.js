...
// ACTIONS
export const updateMessages = (messages) => ({ type: BotActions.UPDATE_MESSAGES, data: messages });
export const setShowDots = (value) => ({ type: BotActions.SET_SHOW_DOTS, data: value });
export const toggleBot = () => ({ type: BotActions.TOGGLE_BOT });
export const toggleMenu = () => ({ type: BotActions.TOGGLE_MENU });
export const setNotification = (notification) => ({ type: BotActions.SET_NOTIFICATION, data: notification });
export const setHumanHandover = (value) => ({ type: BotActions.SET_HUMAN_HANDOVER, data: value });
export const setShowRestartMessage = (value) => ({ type: BotActions.SET_SHOW_RESTART_MESSAGE, data: value });
export const setDisableInput = (value) => ({ type: BotActions.SET_DISABLE_INPUT, data: value });
export const setFirstInteraction = (value) => ({ type: BotActions.SET_FIRST_INTERACTION, data: value });

const botReducer = (state = botInitialState, action) => {
